...
print("Merton [sigma, lam, muJ, sigmaJ] OTM=", res_merton_otm.x, " RMSE OTM =", res_merton_otm.fun)
res_merton_itm = minimize(rmse_merton, x0, args=(calls_itm, S0, r, q, T), bounds=bounds_merton)
print("Merton [sigma, lam, muJ, sigmaJ] ITM=", res_merton_itm.x, " RMSE ITM =", res_merton_itm.fun)
res_merton = minimize(rmse_merton, x0, args=(calls, S0, r, q, T), bounds=bounds_merton)
print("Merton [sigma, lam, muJ, sigmaJ] =", res_merton.x, " RMSE =", res_merton.fun)
